<div class="col-12">
	<h5>
	<img class="restore" title="Reset skin to default" src="/wizard/skins/icons/restore.svg" onclick="look.resetSkin();"> Skin
	</h5>

	<div style="display:flex; justify-content:space-around; width:100%">
	<?php foreach(array('dark', 'light', 'minimal_dark', 'minimal_light', 'transparent_dark', 'transparent_light') as $s) {?>
		<img width="32" class="skins" data-skin="<?=$s?>" src="/wizard/skins/<?=$s?>/home.png">
	<?php } ?>
	</div>
	...
	<h5>
	<img class="restore" title="Reset background to default" src="/wizard/skins/icons/restore.svg" onclick="look.resetBackground();"> Background
	</h5>
	<div class="row">
	...
	<h5>
		<img class="restore" title="Reset tools to default" src="/wizard/skins/icons/restore.svg" onclick="look.resetTools();"> Tools
	</h5>
	<div class="row">
		<div class="col-12">
			...
			<p><img src="/wizard/skins/dark/lighting.png" width="26px"> Lighting 
				<input type="checkbox" name="tools[]" class="switch" value="lighting"></p>
			<p><img src="/wizard/skins/dark/lightcontrol.png" width="26px"> Light Direction
				<input type="checkbox" name="tools[]" class="switch" value="light"></p>
			<p><img src="/wizard/skins/dark/measure.png" width="24px"> Measure
				<input type="checkbox" name="tools[]" class="switch" value="measure"></p>
			<p><img src="/wizard/skins/dark/pick.png" width="24px"> Picking
				<input type="checkbox" name="tools[]" class="switch" value="pick"></p>
			<p><img src="/wizard/skins/dark/sections.png" width="24px"> Sections
				<input type="checkbox" name="tools[]" class="switch" value="sections"></p>
			<p><img src="/wizard/skins/dark/color.png" width="24px"> Solid Color
				<input type="checkbox" name="tools[]" class="switch" value="color"></p>
			<p><img src="/wizard/skins/dark/orthographic.png" width="24px"> Orthographic
			...
			<p><img src="/wizard/skins/dark/full.png" width="24px"> Full Screen
	...
	<hr/>
		...
		<h5>
		<img class="restore" title="Reset widgets to default" src="/wizard/skins/icons/restore.svg" onclick="look.resetWidgets();"> Widgets
		</h5>
		<p id="cbl_basegrid">
