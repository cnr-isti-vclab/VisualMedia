<div class="col-12">
	...
	<div class="d-flex" style="gap:10px">
		<button style="flex-grow:1; flex-basis:0;" class="btn btn-secondary btn-sm" id="bt_setTurntable" onclick="navigation_config.setTurntable();"><img src="/wizard/skins/icons/girabile.png" width="80px">TURNTABLE</button>
		<button style="flex-grow:1; flex-basis:0;" class="btn btn-secondary btn-sm" id="bt_setSphere" onclick="navigation_config.setSphere();"><img src="/wizard/skins/icons/trackball.png" width="80px">SPHERE</button>				
	</div>

	<hr/>

	<h5>
		<img class="restore" title="Reset initial view" src="/wizard/skins/icons/restore.svg" onclick="navigation_config.resetInitialView();"> Initial View
	</h5>
	...
	<h5>
		<img class="restore" title="Reset FOV" src="/wizard/skins/icons/restore.svg" onclick="navigation_config.resetCamera();"> Field of View
	</h5>
	...
	<div class="mt-4">
		<div class="row">
			<p class="col-6">Initial projection:</p>
			<div class="col-6">
			...
			<p class="col-12 mt-2"><img src="/wizard/skins/dark/orthographic.png" width="24px"> 
				<input type="checkbox" id="i_toggleOrtho" class="switch" onchange="navigation_config.setTool('orthographic', this.checked);" 	checked/>
