<div class="col-12">
	<h5>
		<img class="restore" title="Reset colors options to default" src="/wizard/skins/icons/restore.svg" onclick="material_config.materialReset();"> Color
	</h5>
	...
	<div class="row">
		...
		<p class="col-12">
			<img src="/wizard/skins/dark/color.png" width="24px"> <input type="checkbox" class="switch" id="i_toggleColor" onchange="material_config.setTool('color', this.checked);" checked> Texture/Solid toggle</input>
		</p>
	...
	<h5>
		<img class="restore" title="Reset lighting options to default" src="/wizard/skins/icons/restore.svg" onclick="lighting_config.reset();"> Lighting:
	</h5>
	<div class="row">
	...
	<div class="row mt-3">
		<p class="col-12">
		<img src="/wizard/skins/dark/lighting.png" width="24px"> <input type="checkbox" class="switch" id="i_toggleLighting" onchange="lighting_config.setTool('lighting', this.checked);" checked>Lighting on/off toggle</input>
		</p>

		<p class="col-12">
		<img src="/wizard/skins/dark/light.png" width="24px"> <input type="checkbox"  class="switch"id="i_toggleLight" onchange="lighting_config.setTool('light', this.checked);" checked>Light direction tool</input>
		</p>
	</div>
</div>
